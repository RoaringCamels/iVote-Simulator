...
public class AlphanumericGenerator{
    /**
     * This method creates the student ID randomly picked from a default set String notSoRandom
     * @param lengthOfID integer that defines the length of the String to be returned
     ...
     * @param numberOfChoices integer that depends on the number of choices from the quesion
   ...
   public String ABCDGeneratorSC (int numberOfChoices){
    ...
    /**
     * This method randomly generates a String for multiple choice questions. If there are four options,
